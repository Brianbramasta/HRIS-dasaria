...
- **DO**: All application logic, validation, decision making, orchestration, data mapping, loading/error handling
- **DON'T**: JSX/UI, styling, DOM manipulation

### `services/` - Data Access Layer
- **DO**: API communication, endpoint definitions, header & auth setup
- **DON'T**: State storage, complex validation/mapping, UI logic
...
- **DO**: TypeScript type definitions, frontend-backend contracts, DTOs
...
If required folders don't exist in parent, create them first.
...
- Maintain clean architecture flow - no layer jumping
...
2. Check parent folder structure and create missing folders if needed
...
6. Add proper TypeScript types in `types/` folder
7. Include error handling and user feedback in hooks
8. Test the implementation thoroughly before considering it complete
