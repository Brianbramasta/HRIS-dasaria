      ...
      const dummyData: ContractRenewalApprovalListItem[] = [
        {
          ...
          current_contract_start: '2022-01-15',
          current_contract_end: '2024-01-15',
          remaining_month: '2 bulan',
          status: 1,
          status_name: 'Pending',
        ...
        },
        {
          ...
          current_contract_start: '2022-03-20',
          current_contract_end: '2024-03-20',
          remaining_month: '4 bulan',
          status: 2,
        ...
        },
        {
          ...
          current_contract_start: '2021-06-10',
          current_contract_end: '2023-12-31',
          remaining_month: 'Expired',
          status: 1,
          status_name: 'Pending',
          renewal_detail: 'Detail perpanjangan tersedia',
        ...
        },
        {
          ...
          current_contract_start: '2022-08-01',
          current_contract_end: '2024-08-01',
          remaining_month: '8 bulan',
          status: 1,
          status_name: 'Pending',
          renewal_detail: null,
          notes: null,
        ...
        },
        {
          ...
          department_name: 'IT Development',
          current_contract_start: '2021-11-15',
          current_contract_end: '2024-02-15',
          remaining_month: '3 bulan',
          status: 2,
          status_name: 'Diperpanjang',
          renewal_detail: 'Detail perpanjangan tersedia',
        ...
        },
        {
          ...
          current_contract_start: '2022-04-10',
          current_contract_end: '2024-04-10',
          remaining_month: '5 bulan',
          status: 3,
          status_name: 'Ditolak',
          renewal_detail: 'Detail perpanjangan tersedia',
        ...
        },
        {
          ...
          current_contract_start: '2021-09-05',
          current_contract_end: '2024-05-05',
          remaining_month: '6 bulan',
          status: 2,
          status_name: 'Diperpanjang',
          renewal_detail: 'Detail perpanjangan tersedia',
        ...
        },
        {
          ...
          employee_id: 'emp008',
          nip: 'NIP008',
          employee_name: 'Linda Susanti',
          position_name: 'Finance Analyst',
          department_name: 'Finance',
          current_contract_start: '2022-02-28',
          current_contract_end: '2024-02-28',
          remaining_month: '3 bulan',
          status: 1,
          status_name: 'Pending',
          renewal_detail: 'Detail perpanjangan tersedia',
        ...
        },
        {
          ...
          current_contract_start: '2021-12-01',
          current_contract_end: '2024-06-01',
          remaining_month: '7 bulan',
          status: 1,
          status_name: 'Pending',
          renewal_detail: 'Detail perpanjangan tersedia',
        ...
        },
        {
          ...
          employee_id: 'emp010',
          nip: 'NIP010',
          employee_name: 'Ratna Sari',
          position_name: 'Content Writer',
          department_name: 'Content & Media',
          current_contract_start: '2022-07-20',
          current_contract_end: '2024-07-20',
          remaining_month: '8 bulan',
          status: 2,
          status_name: 'Diperpanjang',
          renewal_detail: 'Detail perpanjangan tersedia',
