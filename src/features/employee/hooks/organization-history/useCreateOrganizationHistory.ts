  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const payload = {
        ...
        position_level_id: detailForm.position_level_id || null,
        office_id: detailForm.office_id,
        directorate_id: detailForm.directorate_id || null,
        division_id: detailForm.division_id || null,
        department_id: detailForm.department_id || null,
        job_title_id: detailForm.job_title_id || null,
        structural_job_id: detailForm.structural_job_id || null,
        position_id: detailForm.position_id || null,
