import { FileSummary } from "./organization.api.types";
...
export type EmployeePositionRow = { no: number; 'Nama Posisi': string; Jabatan: string; Direktorat: string; Divisi: string; Departemen: string; 'File SK & MoU': string | FileSummary, fileUrl?: string };
