...
export default function EmployeeFluctuationPanel() {
  ...
  const { series, categories } = useMemo(() => {
    ...
    return {
      ...
      series: [
        { name: "Dasaria (Total)", data: [45, 47, 44, 48, 46, 50, 46, 46, 42, 42, 41, 44] },
        { name: "Dasarata", data: [12, 16, 10, 21, 13, 27, 12, 12, 12, 12, 8, 11] },
        { name: "Griyanet", data: [22, 24, 20, 33, 25, 40, 25, 25, 25, 25, 18, 22] },
      ] as LineSeries[],
    };
  }, [period]);
