      ...
      <div className="space-y-6">
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-xl font-bold text-center">
            Apakah anda yakin melanjutkan ke tahap approval ?
          </h2>
        </div>
        <div className="max-h-[60vh] overflow-y-auto pb-2">
          <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
            {periodDate && <span>Periode gaji yang disahkan akan dikunci dan tidak dapat diubah.</span>}
            {periodDate && (
              <>
                <br />
                <span className="font-semibold">Data yang disahkan pada {periodDate}</span>
                <br />
              </>
            )}
