...
const EditNonRecurringAllowanceModalDelete: React.FC<Props> = ({
  isOpen,
  onClose,
  onDelete,
  allowanceName,
        ...
        <form onSubmit={(e) => { e.preventDefault(); onDelete(); }}>
          <div className='max-h-[60vh] overflow-y-auto pb-4'>
            <p className="mb-4 text-center">
              Apakah Anda yakin ingin menghapus <strong>[{allowanceName}]</strong> dari tunjangan tidak tetap ?
            </p>
            <p className='pt-2 text-start text-xs text-gray-500'>*Data tidak benar-benar dihapus akan tetapi diarsipkan</p>
          </div>
...
export default EditNonRecurringAllowanceModalDelete;
