...
const NonRecurringDeductionModalDelete: React.FC<Props> = ({
  isOpen,
  onClose,
  onDelete,
  deductionName,
        ...
        <form onSubmit={(e) => { e.preventDefault(); onDelete(); }}>
          <div className='max-h-[60vh] overflow-y-auto pb-4'>
            <p className="mb-4 text-center">
              Apakah Anda yakin ingin menghapus <strong>[{deductionName}]</strong> dari potongan tidak tetap ?
            </p>
...
export default NonRecurringDeductionModalDelete;
